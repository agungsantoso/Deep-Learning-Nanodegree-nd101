...
targets_ = tf.placeholder(dtype=tf.float32,
                         shape=(None, 28, 28, 1),
                         name="targets")
encodelayer = lambda x, f: tf.layers.max_pooling2d(pool_size=(2,2), strides=(2, 2), padding="SAME",
                                                   inputs=tf.layers.conv2d(inputs=x, filters=f, kernel_size=(3, 3), 
                                                                           padding="SAME", activation=tf.nn.relu) )
### Encoder
conv1 = encodelayer(inputs_, 16)
# Now 14x14x16
conv2 = encodelayer(conv1, 8)
# Now 7x7x8
encoded = encodelayer(conv2, 8)
# Now 4x4x8

decodelayer = lambda x, f, s: tf.layers.conv2d(filters=f, kernel_size=(3, 3), padding="SAME", activation=tf.nn.relu,
                                               inputs=tf.image.resize_nearest_neighbor(images=x, size=s))
### Decoder
conv4 = decodelayer(encoded, 8, (7, 7))
# Now 7x7x8
conv5 = decodelayer(conv4, 8, (14, 14))
# Now 14x14x8
conv6 = decodelayer(conv5, 16, (28, 28))
# Now 28x28x16
...
decoded = tf.nn.sigmoid(x=logits, name="decoded")
...
### Encoder
conv1 = encodelayer(inputs_, 32)
# Now 14x14x32
conv2 = encodelayer(conv1, 32)
# Now 7x7x32
encoded = encodelayer(conv1, 16)
# Now 4x4x16

### Decoder
conv4 = decodelayer(encoded, 16, (7, 7))
# Now 7x7x16
conv5 = decodelayer(conv4, 32, (14, 14))
# Now 14x14x32
conv6 = decodelayer(conv5, 32, (28, 28))
# Now 28x28x32
