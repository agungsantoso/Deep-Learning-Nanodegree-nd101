...
def model_inputs():
    ...
    """
    # TODO: Implement Function
    input_ = tf.placeholder(dtype=tf.int32, name="input", shape=[None, None])
    target_ = tf.placeholder(dtype=tf.int32, name="target", shape=[None, None])
    learn_rate = tf.placeholder(dtype=tf.float32, name="lr")
    keep_prob = tf.placeholder(dtype=tf.float32, name="keep_prob")
    return (input_, target_, learn_rate, keep_prob)
...
def encoding_layer(rnn_inputs, rnn_size, num_layers, keep_prob):
    ...
    """
    # TODO: Implement Function
    #using loop for because of error thrown by tensorflow 1.1 due to the way they are using stored weights
...
def decoding_layer_infer(encoder_state, dec_cell, dec_embeddings, start_of_sequence_id, end_of_sequence_id,
    ...
    inference_logits = tf.nn.dropout(inference_logits, keep_prob=keep_prob)
...
def seq2seq_model(input_data, target_data, keep_prob, batch_size, sequence_length, source_vocab_size, target_vocab_size,
    ...
    dec_input = process_decoding_input(target_data, 
                                       target_vocab_to_int, 
                                       batch_size)
    dec_embeddings = tf.Variable(tf.truncated_normal(shape=(target_vocab_size, dec_embedding_size),
                                                     stddev=0.1))
...
def sentence_to_seq(sentence, vocab_to_int):
    ...
    """
    # TODO: Implement Function
    return [vocab_to_int.get(id, vocab_to_int['<UNK>']) for id in sentence.split()]
